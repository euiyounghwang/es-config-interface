...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMetricsStatus = channel.unary_unary(
                '/Greeter/GetMetricsStatus',
                request_serializer=service__pb2.MetricsStatusRequest.SerializeToString,
                response_deserializer=service__pb2.MetricsStatusResponse.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMetricsStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.MetricsStatusRequest.FromString,
                    response_serializer=service__pb2.MetricsStatusResponse.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def GetMetricsStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Greeter/GetMetricsStatus',
            service__pb2.MetricsStatusRequest.SerializeToString,
            service__pb2.MetricsStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
